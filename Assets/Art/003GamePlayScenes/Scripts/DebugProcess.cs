...
public class DebugProcess : MonoBehaviour
{
	public 	bool 	isShowFPS		  = true;//是否显示帧数.
	...
	void Start()
	{
		...
		frames = 0;
		//isShowFPS=MDefineCenter.Instance().mShowFPS;
...
//				BA_GlobalProcess.DebugResetPlayerData();
//		}
	}
